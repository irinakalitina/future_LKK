...
class Auth_personal_profile(unittest.TestCase):
    ...
    def test_Auth_personal_profile(self):
        ...
        #element = wd.find_element_by_xpath("//form[@id='lk_form']/div/div[1]/div[2]/div/div/div[8]/div/div[2]/div[2]/div[1]/div[1]/span/span[1]/span/span[2]").click()
        #select = Select(element)
        #select.select_by_visible_text("OPI")
